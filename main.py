...
# Form implementation generated from reading ui file 'dooz.ui'
#
...
class Ui_MainWindow(object):
    ...
    def khob(self):
        try:
            if self.lineEdit.text() == 'x' and self.lineEdit_2.text() == 'x' and self.lineEdit_3.text() == 'x':
                self.label.setText("player x won")
            if self.lineEdit.text() =='x' and self.lineEdit_4.text() =='x' and self.lineEdit_7.text() == 'x':
                self.label.setText("player x won")
            if self.lineEdit.text() =='x' and self.lineEdit_5.text() =='x' and self.lineEdit_9.text() == 'x':
                self.label.setText("player x won")
            if self.lineEdit_2.text() =='x' and self.lineEdit_5.text() =='x' and self.lineEdit_8.text() == 'x':
                self.label.setText("player x won")
            if self.lineEdit_3.text() =='x' and self.lineEdit_6.text() =='x' and self.lineEdit_9.text() == 'x':
                self.label.setText("player x won")
            if self.lineEdit_3.text() =='x' and self.lineEdit_5.text() =='x' and self.lineEdit_7.text() == 'x':
                self.label.setText("player x won")
            if self.lineEdit_4.text() =='x' and self.lineEdit_5.text() =='x' and self.lineEdit_6.text() == 'x':
                self.label.setText("player x won")
            if self.lineEdit_7.text() =='x' and self.lineEdit_8.text() =='x' and self.lineEdit_9.text() == 'x':
                self.label.setText("player x won")
            else:
                self.label.setText("player o won (or no one won.)")
